...
namespace ASPProject.Tests.Tests.Controllers
{
    ...
    [TestClass]
    public class BinControllerMockTest
    {
        ...
        public void SetUp()
        {
            ...
            {
                new Bin { Trash = new List<Trash>(), Id = 1, Description = "Description", Name = "Bin1", ApplicationUserId = "1" },
                new Bin { Trash = new List<Trash>(), Id = 2, Description = "Description", Name = "Bin2", ApplicationUserId = "1" },
                new Bin { Trash = new List<Trash>(), Id = 3, Description = "Description", Name = "Bin3", ApplicationUserId = "1" }
            };
